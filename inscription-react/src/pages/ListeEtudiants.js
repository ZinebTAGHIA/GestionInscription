...
const ListeEtudiants = () => {
  ...
  useEffect(() => {
    setSelectRoles(
      currentStudent.roles ? currentStudent.roles.map((role) => role.id) : ""
    );
  }, [currentStudent]);
  ...
  const roleBodyTemplate = (data) => {
    return data.roles.map((role) => (
      <Tag value={role.name} severity={getSeverity()} rounded />
    ));
  };
                ...
                <div className="card">
                  <Form
                    ...
                    initialValues={{
                      ...
                      filiere:
                        currentStudent && currentStudent.filiere
                          ? currentStudent.filiere.id
                          : "",
                      roles: "",
                      login: currentStudent ? currentStudent.login : "",
          ...
          <>
            ...
            >
              ...
              <Column
                ...
                header="Filière"
              />
              <Column field="intitule" header="Rôles" body={roleBodyTemplate} />
              <Column
                field="operations"
                header="Opérations"
